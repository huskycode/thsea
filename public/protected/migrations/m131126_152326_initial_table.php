...
class m131126_152326_initial_table extends CDbMigration
{
	public function up()
	{
	    ...
	    $this->execute("CREATE TABLE IF NOT EXISTS user (
            ...
            PRIMARY KEY (`id`)
            ) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=tis620;", array());
        
        $this->execute("CREATE TABLE IF NOT EXISTS video (
            ...
            PRIMARY KEY (`id`)
            ) ENGINE=InnoDB AUTO_INCREMENT=4178 DEFAULT CHARSET=tis620 COMMENT='Video'", array());

	    $this->execute("CREATE TABLE IF NOT EXISTS video_tag (
            ...
            ) ENGINE=InnoDB DEFAULT CHARSET=tis620 COMMENT='Video tag'", array());
