...
<div class="container main-wrapper">
    <div id="main-content">
        <p>ทีมงานผู้จัดทำเว็บไซต์ Thailand Software Engineering Academy เป็นกลุ่มคนที่สนใจจะสร้างเว็บไซต์นี้ขึ้นมาด้วยการนำ Scrum มาใช้ในการทำงานร่วมกันและสามารถส่งมอบงานได้อย่างต่อเนื่อง ผ่านเครื่องมือออนไลน์อย่างเช่น Google Hangout, Github, Eidos และ Mural.ly โดยกำหนดช่วงเวลาของ Sprint เป็น 1-2 สัปดาห์ตามขนาดของงาน ซึ่งทุกคนในทีมจะมีส่วนร่วมกันในช่วยกันประเมินขนาดงานแบบ Planning poker ในกิจกรรม Sprint planning ตอนช่วงเริ่มต้น Sprint หลังจากกำหนดขอบเขตของ Sprint ได้ แต่ละคนในทีมจะเลือกงานจาก Backlog ไปทำด้วยตนเอง และสื่อสารกันระหว่าง Sprint ผ่านกิจกรรมที่ทีมเรียกกันว่า Weekly meeting และ Team sync-up เพื่อช่วยกันแก้ปัญหาและประสานงานกันในทีมได้อย่างต่อเนื่อง ซึ่งจะทำให้การส่งมอบเว็บไซด์ในช่วง Sprint review ตรงตามวัตถุประสงค์ของ Sprint นั้น ก่อนที่จะจบ Sprint ด้วยการทำ Sprint retrospective เพื่อมองย้อนกลับไปดูการดำเนินงานที่ผ่านมาใน Sprint และนำไปปรับปรุงรูปแบบการทำงานทั้งของทีมและแต่ละคน

สำหรับผู้ที่สนใจเข้าร่วมทีม สามารถเข้าร่วมกลุ่ม <a href="https://www.facebook.com/groups/thseacademy/">Facebook</a> เพื่อติดตามความเคลื่อนไหว และเข้าร่วมกิจกรรมได้ตามนัดหมายที่ประกาศ ซึ่งจะมีทุกวันพุธและเสาร์ ในเวลา 10.00 - 11.00 pm</p>
